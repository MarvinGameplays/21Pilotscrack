...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if username not in config.PV_USERS:
            bot.sendMessage(update.message.chat.id,'💢Pídele acceso a mi desarrollador💢: @PILOTS21')
            return
        ...
        if config.getUser(username) is None:
            ...
            reply_msg+= 'Soy el bot personal de @PILOTS21\n'
        ...
        if '/start' in msgText:
            start_msg = 'Bot : @PILOTS21 bot😉\n'
            start_msg+= 'Propietario : @PILOTS21\n'
            start_msg+= 'Desarrollo : @PILOTS21\n'
            start_msg+= 'Hola😃 Descargo y subo gratis sin gasto de mb!!😉\n'
